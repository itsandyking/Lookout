...
def generate_google_shopping(output_path, store) -> dict:
    ...
    headers = [
        ...
        "Handle",
        "Command",
        "Metafield: google_shopping.google_product_category [string]",
        "Metafield: google_shopping.gender [string]",
        "Metafield: google_shopping.age_group [string]",
        "Metafield: google_shopping.condition [string]",
        "Metafield: google_shopping.color [string]",
        "Metafield: google_shopping.size [string]",
        "Metafield: google_shopping.size_system [string]",
        "Metafield: google_shopping.custom_label_0 [string]",
        "Metafield: google_shopping.custom_label_1 [string]",
        "Metafield: google_shopping.custom_label_2 [string]",
        "SEO Title",
        "SEO Description",
    ]
    ws.append(headers)
